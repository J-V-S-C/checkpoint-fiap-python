...
O código espera 2 inputs do usuário, a data atual e a data de vencimento, com base nesses dados é verificado se:
  ...
  - A diferença entre o dia atual e o de vencimento é menor(ou igual) à 5;
  Se nenhuma dessas condições for verdadeira o produto será da categoria comum

O programa retorna a categoria do produto.
